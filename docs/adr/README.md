...
| # | Title | Status |
|---|---|---|
| [0018](0018-operator-preferences-bilateral-maintenance.md) | Operator preferences — bilateral maintenance, structured TOML | Accepted (ships v2.8.1) |
...
| [0012](0012-1password-service-accounts-multibackend.md) | Multi-backend secret resolution with 1Password Service Accounts as first-class option | Accepted (shipped v2.7.31) |
