...
func (m Model) handleKey(msg tea.KeyMsg) (tea.Model, tea.Cmd) {
	...
	case "down", "j":
		// Down arrow moves toward higher-index (visually-lower) sessions.
		// Was inverted in v0.3.0 — fixed in v0.4.1.
	...
	case "up", "K":
		// Up arrow moves toward lower-index (visually-higher) sessions.
		// 'K' (capital) is up; lowercase 'k' is taken by kill-session.
		if m.selected > 0 {
			m.selected--
			m.applyPreviewForSelected()
		}
